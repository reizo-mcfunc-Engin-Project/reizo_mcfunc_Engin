#> reizo_libs:display_backup/sys/load/_
#
# 
#
# @within function reizo_libs:display_backup/load

# Storageコピーできなかったらおしまい。
execute \
unless data storage reizo_mcfunc_engin:lib DisplayBackUp.BackUpData run \
return run function reizo_libs:display_backup/sys/load/fail
...
# 生きているかチェック
function reizo_libs:display_backup/sys/load/check/set_pos.m with storage reizo_mcfunc_engin:lib DisplayBackUp.Macro
function reizo_libs:display_backup/sys/load/check/set_pos.m with storage reizo_mcfunc_engin:lib DisplayBackUp.Macro
function reizo_libs:display_backup/sys/load/check/set_pos.m with storage reizo_mcfunc_engin:lib DisplayBackUp.Macro
...
function reizo_libs:display_backup/sys/load/summon.m with storage reizo_mcfunc_engin:lib DisplayBackUp.Macro
