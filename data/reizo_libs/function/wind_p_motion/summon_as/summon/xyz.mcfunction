#> reizo_libs:wind_p_motion/summon_as/summon/xyz
#
# 
#
# @within function reizo_libs:wind_p_motion/summon_as/xyz
...
#> まだ値があるなら再帰
    ...
    return run function reizo_libs:wind_p_motion/summon_as/summon/xyz
    # y
    execute \
