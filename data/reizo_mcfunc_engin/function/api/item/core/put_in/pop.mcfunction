...
# Slot
execute if score $Item.foreach.RunSlot reizo_mcfunc_Engin.Temp matches 0..35 run return run function reizo_mcfunc_engin:asset/item/.manager/tick/run/common/in_this/pop/core/not_hold/slot
