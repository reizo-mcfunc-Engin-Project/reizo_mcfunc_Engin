#> reizo_mcfunc_engin:api/super/core/item_data_merge/slot/remove/_
#
# 
#
...
# マクロでデータをマージする
function reizo_mcfunc_engin:api/super/core/item_data_merge/slot/remove/_.m with storage reizo_mcfunc_engin:api Super.ItemDataMerge.Slot
