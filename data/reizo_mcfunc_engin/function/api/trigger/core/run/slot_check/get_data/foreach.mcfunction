#> reizo_mcfunc_engin:api/trigger/core/run/slot_check/get_data/foreach
#
# 
#
...
# マクロでデータを取得
function reizo_mcfunc_engin:api/trigger/core/run/slot_check/get_data/get/_
...
# 先頭が残るなら再帰
execute if data storage reizo_mcfunc_engin:api Trigger.run.Item.Slot[0] run function reizo_mcfunc_engin:api/trigger/core/run/slot_check/get_data/foreach