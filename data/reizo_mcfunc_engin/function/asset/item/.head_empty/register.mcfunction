#> reizo_mcfunc_engin:asset/item/.head_empty/register
#
# 
#
...
#> 登録処理
    # 継承(オプション)
    data modify storage reizo_mcfunc_engin:item Register.Extends append value {ID:".head_example",namespace:"reizo_mcfunc_engin"}
    # 継承されないかどうか。 boolean型
    ...
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"ラム...ラムネ?"}]
    # 消費アイテム
