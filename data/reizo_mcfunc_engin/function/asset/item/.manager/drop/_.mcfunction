...
execute unless data entity @n[tag=reizo_mcfunc_Engin.Item.Drop] Item.components."minecraft:custom_data".Item.Registry{Drop:1b} run return run tag @n[tag=reizo_mcfunc_Engin.Item.Drop] remove reizo_mcfunc_Engin.Item.Drop
