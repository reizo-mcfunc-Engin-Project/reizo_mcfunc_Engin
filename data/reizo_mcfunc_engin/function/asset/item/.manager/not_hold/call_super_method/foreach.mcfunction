#> reizo_mcfunc_engin:asset/item/.manager/not_hold/call_super_method/foreach
#
# 
#
# @within function reizo_mcfunc_engin:asset/item/.manager/not_hold/call_super_method/_
