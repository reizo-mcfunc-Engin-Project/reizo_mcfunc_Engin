...
data modify storage reizo_mcfunc_engin:item _.Registry set from storage reizo_mcfunc_engin:item data.Equipment.head.components."minecraft:custom_data".Item.Registry
