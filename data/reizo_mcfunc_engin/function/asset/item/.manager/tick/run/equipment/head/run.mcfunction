...
execute \
if data storage reizo_mcfunc_engin:item data.Equipment.head.components."minecraft:custom_data".Item.Registry.Extends run \
function reizo_mcfunc_engin:asset/item/.manager/tick/run/equipment/legs/extends
