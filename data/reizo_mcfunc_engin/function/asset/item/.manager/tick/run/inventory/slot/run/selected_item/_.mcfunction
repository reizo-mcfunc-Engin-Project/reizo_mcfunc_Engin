#> reizo_mcfunc_engin:asset/item/.manager/tick/run/inventory/slot/run/selected_item/_
#
# 
#
...
execute \
if data storage reizo_mcfunc_engin:item data.SelectedItem.components."minecraft:custom_data".Item.Registry.Extends run \
function reizo_mcfunc_engin:asset/item/.manager/tick/run/inventory/slot/run/selected_item/extends
