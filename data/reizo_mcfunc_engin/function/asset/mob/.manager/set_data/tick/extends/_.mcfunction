#> reizo_mcfunc_engin:asset/mob/.manager/set_data/tick/extends/_
#
# 
#
...
# 継承情報コピー
data modify storage reizo_mcfunc_engin:mob CopyExtends set from entity @s data.Registry.Extends
