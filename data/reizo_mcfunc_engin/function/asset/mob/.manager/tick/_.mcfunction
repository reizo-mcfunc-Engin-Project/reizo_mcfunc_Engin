...
execute unless data storage reizo_mcfunc_engin:mob {Implement:1b} if data storage reizo_mcfunc_engin:context data.Registry.Extends run function reizo_mcfunc_engin:asset/mob/.manager/tick/call_super_method/_
