#>reizo_mcfunc_engin:asset/mob/super.test_2/register
#
# Mobの登録処理
#
...
#> データ登録
   ...
   # 名前 String型
   data modify storage reizo_mcfunc_engin:mob Register.Name set value "無名"
   # 体力はどれぐらい？ Float型
   ...
   # 持っているアイテム String型
       ...
       # chest
       # data modify storage reizo_mcfunc_engin:mob Register.Chest set value {id:}
       # legs
       ...
       # main_hand
       data modify storage reizo_mcfunc_engin:mob Register.main_hand set value {id:"iron_sword"}
       # off_hand
