...
execute \
    if data storage reizo_mcfunc_engin:object Temp.Cache{Implement:1b} run \
    data modify storage reizo_mcfunc_engin:object Cache.Tick append from storage reizo_mcfunc_engin:context Register.Extends[0]
