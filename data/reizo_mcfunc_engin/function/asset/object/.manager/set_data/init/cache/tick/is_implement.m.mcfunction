#> reizo_mcfunc_engin:asset/object/.manager/set_data/init/cache/tick/is_implement.m
#
# 
#
# @within function reizo_mcfunc_engin:asset/object/.manager/set_data/init/cache/tick/foreach
