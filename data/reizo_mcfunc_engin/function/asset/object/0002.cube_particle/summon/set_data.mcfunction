...
# ID,namespaceの取得
    data modify entity @s data.Object.ID set from storage reizo_mcfunc_engin:context Args.ID
    data modify entity @s data.Object.namespace set from storage reizo_mcfunc_engin:context Args.namespace
