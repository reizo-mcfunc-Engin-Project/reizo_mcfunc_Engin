#> reizo_mcfunc_engin:lib/hex_to_rgb/conversion/_
#
# 
#
# @within function reizo_mcfunc_engin:lib/hex_to_rgb/_
...
# 値を数値に。
function reizo_mcfunc_engin:lib/hex_to_rgb/conversion/1/_
function reizo_mcfunc_engin:lib/hex_to_rgb/conversion/2/_
