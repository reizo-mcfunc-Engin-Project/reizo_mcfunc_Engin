...
tellraw @a [{"text":"値は、",color:"white"},{"text":"正の数",color:"gold",hover_event:{action:"show_text",value:[{"text":"Obj名",color:"aqua"},{"text":":",color:"white"},{"text":"$(Obj)",color:"green"},{"text":"\nホルダー名"},{"text":":",color:"white"},{"text":"$(Selecter)\n",color:"green"},{"text":"Value",color:"aqua"},{"text":":",color:"white"},{"score":{name:"$Signum",objective:"reizo_mcfunc_Engin.Temp"},color:"gold"}]}},{"text":"でした。",color:"white"}]

# 負の数来たぞ。
$execute \
if data storage reizo_mcfunc_engin:lib {Return:{Signum:-1.0f}} run \
tellraw @a [{"text":"値は、",color:"white"},{"text":"負の数",color:"gold",hover_event:{action:"show_text",value:[{"text":"Obj名",color:"aqua"},{"text":":",color:"white"},{"text":"$(Obj)",color:"green"},{"text":"\nホルダー名"},{"text":":",color:"white"},{"text":"$(Selecter)\n",color:"green"},{"text":"Value",color:"aqua"},{"text":":",color:"white"},{"score":{name:"$Signum",objective:"reizo_mcfunc_Engin.Temp"},color:"gold"}]}},{"text":"でした。",color:"white"}]