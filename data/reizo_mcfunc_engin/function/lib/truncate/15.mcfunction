...
# 
#
# @within function reizo_mcfunc_engin:lib/truncate/14
...
#> 必要なもの以外消す。
    ...
    return run data modify storage reizo_mcfunc_engin:lib Return.Truncate set string storage reizo_mcfunc_engin:lib Truncate.String 0 23
